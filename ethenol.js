...
$("#ENA-Yes").click(() => {
  ...
  $("#notWord").css("display", "inline-block");
  enaYes = true;
  enaNo = false;
});
$("#ENA-No").click(() => {
...
function setValues() {
  let value1 = safeParseFloat(document.getElementById("eight2").value);
  let value4 = safeParseFloat(document.getElementById("eight").value);
  let value2 = safeParseFloat(document.getElementById("ten").value);
  let value3 = value1 * value2;
  let value5 = value4 * value2;
  document.getElementById("fourtysix").value = value5;
  document.getElementById("fourtysix2").value = value3;
  formatNumber("fourtysix");
  formatNumber("fourtysix2");
}
function setValues2() {
  let value1 = safeParseFloat(document.getElementById("eighteen2").value);
  let value4 = safeParseFloat(document.getElementById("eighteen").value);
  let value2 = safeParseFloat(document.getElementById("twenty").value);
  let value3 = value1 * value2;
  let value5 = value4 * value2;
  document.getElementById("fiftyfour").value = value5;
  document.getElementById("fiftyfour2").value = value3;
  formatNumber("fiftyfour");
  formatNumber("fiftyfour2");
}
function setValues3() {
  let value1 = safeParseFloat(document.getElementById("twentythree2").value);
  let value4 = safeParseFloat(document.getElementById("twentythree").value);
  let value2 = safeParseFloat(document.getElementById("twentyfive").value);
  let value3 = value1 * value2;
  let value5 = value4 * value2;
  document.getElementById("fiftyeight").value = value5;
  document.getElementById("fiftyeight2").value = value3;
  formatNumber("fiftyeight");
  formatNumber("fiftyeight2");
}
function setValues4() {
  let value1 = safeParseFloat(document.getElementById("thirtyeight2").value);
  let value4 = safeParseFloat(document.getElementById("thirtyeight").value);
  let value2 = safeParseFloat(document.getElementById("fourty").value);
  let value3 = value1 * value2;
  let value5 = value4 * value2;
  document.getElementById("seventy").value = value5;
  document.getElementById("seventy2").value = value3;
  formatNumber("seventy");
  formatNumber("seventy2");
}
function formatNumberPDF(valuePDF) {
  ...
  // Convert to crores
  let croreValue = valuePDF / 10000000;
...
function collectAndSendData1() {
  ...
  const data = {
    ...
    Q17: safeParseFloat(document.getElementById("nintyfive2").value),
  };
  ...
  let addCost = total;
  let costSavedPerLtr = data.Q17;
  let netProfit = profit - addCost + costSavedPerLtr;
  ...
  console.log("18) Cost Saved Per Litr", Math.round(costSavedPerLtr));
  console.log("19) Net Profit", Math.round(netProfit));
...
function collectAndSendData2() {
  ...
  const data = {
    ...
    Q17: safeParseFloat(document.getElementById("hundred2").value),
  };
  ...
  console.log("23) Cost Saved per ltr", Math.round(costSavedPerLtr));
  console.log("24) Net Profit", Math.round(netProfit));
  showCalculateConatiner();
...
function collectAndSendData5() {
  ...
  const data = {
    ...
    Q17: safeParseFloat(document.getElementById("hundredfifteen2").value),
  };
  let exemptSupplyUptodate = data.eighth2 + data.ninth2;
  let exemptSupplySaletoliqur = data.two * data.four + data.eighth;
  let exemptTotal1 = exemptSupplyUptodate + exemptSupplySaletoliqur;
  ...
  console.log("21) Profit", Math.round(profit));
  console.log("22) Additional Cost", Math.round(addCost));
  console.log("23) Cost Saved Per Litr", Math.round(costSavedPerLtr));
  console.log("24) Net Profit", Math.round(netProfit));
  showCalculateConatiner();
...
function collectAndSendData6() {
  ...
  const data = {
    ...
    Q17: safeParseFloat(document.getElementById("hundredtwenty2").value),
  };
  let exemptSupplyCurrent = data.eighth + data.ninth;
  let exemptSupplyProposed = data.eighth;
  let totalSupplyCurrent = data.six + data.seven + data.eighth + data.ninth;
...
async function updatePDFAndDownload(
  ...
  const firstPage = pdfDoc.getPages()[2];
  ...
  secondPage.drawText(formatNumberPDF(value16).toString(), {
    x: 480,
    y: 504,
    size: 12,
    color: PDFLib.rgb(0, 0, 0),
...
async function updatePDFAndDownload1(
  value0,
  value1,
  value2,
  value3,
...
async function updatePDFAndDownload2(
  ...
  secondPage.drawText(formatNumberPDF(value22).toString(), {
    x: 430,
    y: 500,
    size: 12,
    color: PDFLib.rgb(0, 0, 0),
  });
  secondPage.drawText(formatNumberPDF(value23).toString(), {
    x: 430,
    y: 476,
    size: 12,
    color: PDFLib.rgb(0, 0, 0),
  });
  secondPage.drawText(formatNumberPDF(value24).toString(), {
    x: 430,
    y: 450,
    size: 12,
    color: PDFLib.rgb(0, 0, 0),
...
async function updatePDFAndDownload21(
  value0,
  value1,
  value2,
  value3,
